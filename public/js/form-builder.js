...
(function ($) {
  var FormBuilder = function FormBuilder(options, element) {
    ...
    var defaults = {
      ...
      controlOrder: ['checkbox', 'checkbox-group', 'date', 'file', 'header','paragraph', 'number', 'radio-group', 'select', 'text', 'textarea'],
      dataType: 'xml',
      ...
      messages: {
        ...
        className: 'Class',
        clearAllMessage: '¿Está seguro de que desea borrar todos los campos?',
        clearAll: 'Limpiar',
        close: 'Cerrar',
        content: 'Contenido',
        ...
        fieldRemoveWarning: '¿Seguro que desea eliminar este campo?',
        fileUpload: 'Subir archivo',
        formUpdated: 'Formulario Updated',
        ...
        optionEmpty: 'Valor de la opción requerido',
        other: 'Otro',
        paragraph: 'Párrafo',
    ...
    function inputUserAttrs(name, attrs) {
      ...
      var textInput = '<input ' + utils.attrString(textAttrs) + ' disabled>',
