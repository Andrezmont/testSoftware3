...
function eliminar(id) {
    if (confirm('Esta Seguro?')) {
        ...
        toastr["warning"]("El proveedor se ha Eliminado!.", "Importante!");
        $.ajax({
            url: "/account/proveedor/",
            type: 'DELETE',
            data: {
                'id': id
            },
...
function mostrar(entrada) {
    ...
    $("#deleteAll").click(function() {
        if (confirm('Esta Seguro?')) {
            ...
            //success error warning info
            toastr["warning"]("Los clientes se han Eliminado!.", "Importante!");
            $("input[type='checkbox']").each(function() {
                if ($(this).is(":checked")) {
                    $.ajax({
                        url: "http://" + window.location.hostname + ":" + window.location.port + "/account/proveedor/",
                        type: 'DELETE',
                        data: {
                            'id': $(this).attr("class")
                        },
