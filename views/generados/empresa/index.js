(function() {
    ...
    exports.init = function(req, res) {
        ...
        req.app.db.models.User.findById(req.user.id, {
            ...
            res.render('generados/empresa/inicio', {
    ...
    exports.actualizar = function(req, res) {
        var item = req.body;
        req.app.db.models.empresa.update({
            '_id': item._id
    ...
    exports.eliminar = function(req, res, next) {
        ...
        req.app.db.models.empresa.findByIdAndRemove(req.body.id, function(err, account) {
            if (err) {
                res.send('Error');
            } else {
                res.send('Ok');
    ...
    exports.ingresar = function(req, res) {
        ...
        req.app.db.models.empresa.create(item, function(err, doc) {
            if (err) {
                console.log(err);
                res.send('Error');
            } else {
    ...
    exports.buscar = function(req, res) {
        ...
        req.app.db.models.empresa.find({
    ...
    exports.ver = function(req, res) {
        req.app.db.models.empresa.findById(req.body.id, {
            'data': 1
        }, function(err, doc) {
            if (err) {
                console.log(err);
    ...
    exports.init2 = function(req, res) {
        ...
        req.app.db.models.User.findById(req.user.id, {
            ...
            res.render('generados/empresa/personalizar', {
                'usuario': user.username,
                'modulo': 'empresa'
            });
        });
    ...
    exports.init3 = function(req, res) {
        ...
        req.app.db.models.User.findById(req.user.id, 'username').exec(function(err, user) {
            ...
            res.render('generados/empresa/migrar', {
                'usuario': user.username
            });
        });
    };
                ...
                req.app.db.models.User.findById(req.user.id, {
                    ...
                    req.app.db.models.campo.find({
                        ...
                        for (var i = jsonObj.length - 1; i >= 0; i--) {
                             ...
                             **/
                            req.app.db.models.empresa.create(data);
                        }
